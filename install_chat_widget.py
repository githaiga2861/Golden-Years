#!/usr/bin/env python3
"""Adds the 'coming soon' chat widget (trigger + floating panel) to every
main-site public page's sticky quickbar. Run from inside ~/Golden-Years."""
import glob
...
PANEL = '''<div class="chat-panel" id="chatPanel">
  <div class="chat-panel__head">
    <img src="/images/logo.png" alt="Golden Years Home Health LLC logo">
    <div><strong>Golden Years Home Health LLC</strong><span>Typically replies within a day</span></div>
  ...
  <div class="chat-panel__body">
    <div class="chat-msg">
      ...
      <div class="chat-msg__bubble"><strong>Golden Years Home Health LLC</strong><br>Hi there! \U0001F44B Our live chat is being built right now and is coming very soon. In the meantime, tap "Request a Consultation" below or give us a call \u2014 a real person is always happy to help.</div>
    </div>
...
OLD_INNER = '<div class="quickbar" id="mainQuickbar"><div class="quickbar__inner">\n  <span class="quickbar__txt">'
NEW_INNER = '<div class="quickbar" id="mainQuickbar"><div class="quickbar__inner">\n  ' + TRIGGER + '\n  <span class="quickbar__txt">'
...
for page in PAGES:
    ...
    # insert panel right after the quickbar's closing tags
